        ...
        <body>
            ...
            <main id="body" class="width">
                ...
                <aside id="sidebar" class="column-left">
                    ...
                    <nav id="mainnav">
                        <ul>
                            ...
                            <li><a href="update_career_events/Events.html">Events/Specials</a></li>
                            <li><a href="update_career_events/Careers.html">Career Opportunities</a></li>
                ...
                <main id="content" class="column-right">
                    ...
                    <h1 align="center">Burgers And Wraps</h1>
                    <br>
                    <br>
                    <p id="homeparagraph">GL - (Gluten - Less)    SF - (Soy Free)   NF - (Nut Free)</p>

                    <p id="homeparagraph">Add billy goat chips for $1 more. / Add housemade coleslaw or tater tots for $2 more. / Add a side kale salad for $3 more.</p>
                    <?php $page = "burgers_and_wraps"; include_once('displayShoppingCart.php'); ?>
                    <table class="bordermenu"> 
                        <div id="product-grid">
                            <?php
                            $query = "SELECT * FROM tblproduct ";
                            $query .= " WHERE category = 'burgers_and_wraps' ";
                                        ...
                                        <td>
                                            ...
                                            <div class="product-tile-footer">
                                                <div class="cart-action">
                                                    <form method="post" action="burgers_and_wraps.php?action=add&id=<?php echo $product_array[$key]["id"]; ?>">
