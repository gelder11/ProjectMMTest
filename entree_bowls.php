        ...
        <body>
            ...
            <main id="body" class="width">
                ...
                <main id="content" class="column-right">
                    ...
                    <h1 align="center">Entree Bowls</h1>
                    <br>
                    <br>
                    <h5 align ="center">GL - (Gluten - Less)    SF - (Soy Free)   NF - (Nut Free)</h5>
                    <?php $page = "entree_bowls"; include_once('displayShoppingCart.php'); ?>

                    <table class="bordermenu"> 
                        <div id="product-grid">
                            <?php
                            $query = "SELECT * FROM tblproduct ";
                            $query .= " WHERE category = 'entree_bowls' ";
                                        ...
                                        <td>
                                            ...
                                            <div class="product-tile-footer">
                                                <div class="cart-action">
                                                    <form method="post" action="entree_bowls.php?action=add&id=<?php echo $product_array[$key]["id"]; ?>">
